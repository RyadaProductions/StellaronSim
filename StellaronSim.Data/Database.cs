...
using StellaronSim.Data.NonGenerateModels;
...
public class Database
{
    ...
    public Database(string jsonLocation)
    {
        _simulationData = CalculatorConfig.FromJson(jsonLocation);
    }
    ...
    public CharacterStats GetStatsAtLevel(string characterName, int level)
    {
        ...
        var levelData = character.LevelData.Where(x => x.MaxLevel > level).MinBy(x => x.MaxLevel);
